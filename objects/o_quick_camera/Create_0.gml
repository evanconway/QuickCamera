...
/*
The Quick Camera lets users quickly setup a camera for any Game Maker studio 2 
project. However, it was designed with low res games in mind. Most of the
fundamental scripts this object works as a wrapper for can be found in this
video: https://www.youtube.com/watch?v=_g1LQ6aIJFk
...
set_view_size() and set_view_pos() are fairly self explanatory. The "view" is
the area of the room that is actually displayed to the screen. Note, the view 
is STRETCHED to the surface. This is an important difference from the surface,
which is SCALED to the window. If the view has 4:3 dimensions, and the surface 
has 16:9, then the 4:3 view will get stretched and distorted into a 16:9 
picture.
